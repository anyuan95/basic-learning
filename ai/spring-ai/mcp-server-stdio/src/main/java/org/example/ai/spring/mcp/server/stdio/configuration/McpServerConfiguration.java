package org.example.ai.spring.mcp.server.stdio.configuration;
...
import org.example.ai.spring.mcp.server.stdio.tools.TimeTools;
...
public class McpServerConfiguration {
    ...
    @Bean
    public ToolCallbackProvider myTools(TimeTools timeTools) {
